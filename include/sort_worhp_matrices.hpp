    ...
    */
    auto sortDG(MatrixEntry a, MatrixEntry b)
    {
    ...
    * Intend is to sort UserDG according to WORHP's desire
    */
    auto sortDG_strong(MatrixEntry_strong a, MatrixEntry_strong b)
    {
        return [](auto a,auto b) -> bool
        {
                // 1) the column index of a is smaller than b's
    ...
    */
    auto sortHM(size_t sizeHM, MatrixEntry a, MatrixEntry b)
    {
    ...
    auto sortHM_strong(size_t sizeHM, MatrixEntry_strong a, MatrixEntry_strong b)
    {
        return [sizeHM](auto a, auto b)->bool
            {    
                // 1) a is in the lower triangle and b on the main diagonal
